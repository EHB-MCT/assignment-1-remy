...
- Packages names:
Names of packages are always lowercase and do not use underescores. If you need to use multiple words, use camel case.
...
Put space between keywords and the corresponding opening parenthesis. (if, when, for, and while)
